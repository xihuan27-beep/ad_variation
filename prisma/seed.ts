  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    products: [
      ...
      },
      {
        ...
        areas: [
          { displayOrder: 1, areaName: '메인 동영상 (9:16형)', areaType: AssetAreaType.VIDEO, widthPx: 720, heightPx: 1280, ratio: '9:16', maxDurationSec: 90, formats: ['MP4', 'MOV', 'AVI'], specLabel: '720 × 1280 px (9:16) / 기본 6초 이상, 최대 90초 이내 (필수) / MP4, MOV, AVI 등 일반 동영상 포맷 / 16:9 영상 재편집 후 사용 불가', isUserInput: false },
          { displayOrder: 2, areaName: '메인 동영상 (1:1형)', areaType: AssetAreaType.VIDEO, widthPx: 720, heightPx: 720, ratio: '1:1', maxDurationSec: 90, formats: ['MP4', 'MOV', 'AVI'], specLabel: '720 × 720 px (1:1) / 기본 6초 이상, 최대 90초 이내 (필수) / MP4, MOV, AVI 등 일반 동영상 포맷', isUserInput: false },
          { displayOrder: 3, areaName: '썸네일 이미지 (9:16형)', areaType: AssetAreaType.IMAGE, widthPx: 720, heightPx: 1280, ratio: '9:16', maxFileSizeKb: 400, formats: ['JPG', 'JPEG', 'PNG'], specLabel: '720 × 1280 px (9:16) / 400KB 이하 / JPG, JPEG, PNG', isUserInput: false },
          { displayOrder: 4, areaName: '썸네일 이미지 (1:1형)', areaType: AssetAreaType.IMAGE, widthPx: 720, heightPx: 720, ratio: '1:1', maxFileSizeKb: 400, formats: ['JPG', 'JPEG', 'PNG'], specLabel: '720 × 720 px (1:1) / 400KB 이하 / JPG, JPEG, PNG', isUserInput: false },
          { displayOrder: 5, areaName: '광고 프로필 이미지', areaType: AssetAreaType.IMAGE, widthPx: 300, heightPx: 300, ratio: '1:1', maxFileSizeKb: 200, formats: ['JPG', 'JPEG', 'PNG'], specLabel: '300 × 300 px (1:1) / 200KB 이하 / JPG, JPEG, PNG', isUserInput: false },
          { displayOrder: 6, areaName: '광고 프로필 이름', areaType: AssetAreaType.TEXT, maxChars: 14, specLabel: '최대 14자 (띄어쓰기 포함)', isUserInput: true },
          { displayOrder: 7, areaName: '광고 문구', areaType: AssetAreaType.TEXT, maxChars: 120, specLabel: '최대 120자 (띄어쓰기 포함)', isUserInput: true },
          { displayOrder: 8, areaName: '광고 제목', areaType: AssetAreaType.TEXT, maxChars: 28, specLabel: '최대 28자 (띄어쓰기 포함)', isUserInput: true },
          { displayOrder: 9, areaName: '행동 유도 버튼', areaType: AssetAreaType.TEXT, specLabel: '선택 입력 / 미입력 시 버튼 미노출', isUserInput: true },
          { displayOrder: 10, areaName: '랜딩 URL', areaType: AssetAreaType.URL, specLabel: null, isUserInput: true },
        ],
      },
      {
        ...
        areas: [
          { displayOrder: 1, areaName: '소재 이미지 (750×280)', areaType: AssetAreaType.IMAGE, widthPx: 750, heightPx: 280, maxFileSizeKb: 250, formats: ['PNG'], isTransparentBg: true, needsDarkMode: true, specLabel: '750 × 280 px / PNG (투명 배경 처리 필수) / 250KB 이하 / 라이트모드·다크모드 자동 적용 (소재 1장으로 처리) / 오브젝트+텍스트+랜딩아이콘 구성 PNG 1장 / 텍스트 상하단·좌우측 40px 여백 준수', isUserInput: false },
          { displayOrder: 2, areaName: '광고 메인 카피', areaType: AssetAreaType.TEXT, specLabel: '메인 1행 Bold / 산돌네오고딕(권장) 또는 나눔바른고딕 / #1C1C1C', isUserInput: true },
          { displayOrder: 3, areaName: '광고 서브 카피', areaType: AssetAreaType.TEXT, specLabel: '서브 2행 Regular / 산돌네오고딕 또는 나눔바른고딕 / #2E2E2E', isUserInput: true },
          { displayOrder: 4, areaName: '심의필·고지문구 (해당 시)', areaType: AssetAreaType.TEXT, specLabel: '3행 Regular / #424242 / 16px 고정 / 하단에만 배치', isUserInput: true },
          { displayOrder: 5, areaName: '랜딩 URL', areaType: AssetAreaType.URL, specLabel: null, isUserInput: true },
        ],
      },
      {
        ...
        areas: [
          { displayOrder: 1, areaName: '소재 이미지 (750×200)', areaType: AssetAreaType.IMAGE, widthPx: 750, heightPx: 200, maxFileSizeKb: 150, formats: ['PNG'], isTransparentBg: true, specLabel: '750 × 200 px / PNG (투명 배경 처리 필수) / 150KB 이하 / PSD 샘플 기준 제작 필수 / 오브젝트 최대 260×200px (실사용 70% 이내) / 텍스트 상하 60px 여백·우측 80px / 오브젝트-텍스트 간격 30px 이상', isUserInput: false },
          { displayOrder: 2, areaName: '광고 메인 카피', areaType: AssetAreaType.TEXT, specLabel: '메인 1행 Bold / 산돌네오고딕(권장) 또는 나눔바른고딕 / #1C1C1C', isUserInput: true },
          { displayOrder: 3, areaName: '광고 서브 카피', areaType: AssetAreaType.TEXT, specLabel: '서브 2행 Regular / 산돌네오고딕 또는 나눔바른고딕 / #2E2E2E', isUserInput: true },
          { displayOrder: 4, areaName: '심의필·고지문구 (해당 시)', areaType: AssetAreaType.TEXT, specLabel: '3행 Regular / #424242 / 16px 고정 / 하단에만 배치 (PSD 고지문구형 파일 참고)', isUserInput: true },
          { displayOrder: 5, areaName: '랜딩 URL', areaType: AssetAreaType.URL, specLabel: null, isUserInput: true },
        ],
      },
      {
        ...
        areas: [
          { displayOrder: 1, areaName: '소재 이미지 (750×160)', areaType: AssetAreaType.IMAGE, widthPx: 750, heightPx: 160, maxFileSizeKb: 150, formats: ['PNG'], isTransparentBg: true, specLabel: '750 × 160 px / PNG (투명 배경 처리 필수) / 150KB 이하 / PSD 샘플 기준 제작 필수 / 오브젝트 최대 260×160px (실사용 70% 이내) / 텍스트 상하 40px·우측 80px 여백 / 오브젝트-텍스트 간격 30px 이상 / AD Mute 버튼 영역 고려 필수 (좌우 40px)', isUserInput: false },
          { displayOrder: 2, areaName: '광고 메인 카피', areaType: AssetAreaType.TEXT, specLabel: '메인 1행 Bold / 산돌네오고딕(권장) 또는 나눔바른고딕 / #1C1C1C / 심의필 2줄 적용 시 카피 1줄만 사용 가능', isUserInput: true },
          { displayOrder: 3, areaName: '광고 서브 카피', areaType: AssetAreaType.TEXT, specLabel: '서브 2행 Regular / 산돌네오고딕 또는 나눔바른고딕 / #2E2E2E', isUserInput: true },
          { displayOrder: 4, areaName: '심의필·고지문구 (해당 시)', areaType: AssetAreaType.TEXT, specLabel: '3행 Regular / #424242 / 16px 고정 / 하단에만 배치 / 좌측 또는 우측 배치 선택 / 상단 배치 불가', isUserInput: true },
          { displayOrder: 5, areaName: '랜딩 URL', areaType: AssetAreaType.URL, specLabel: null, isUserInput: true },
        ],
      },
      {
        ...
        areas: [
          { displayOrder: 1, areaName: '배너 이미지 (1250×560)', areaType: AssetAreaType.IMAGE, widthPx: 1250, heightPx: 560, ratio: '2.3:1', maxFileSizeKb: 250, formats: ['PNG', 'JPG', 'JPEG'], specLabel: '1250 × 560 px (비율 2.3:1) / 최소 50KB 이상, 최대 250KB 이하 / PNG, JPG, JPEG / 1장 납품 / SAFE AREA 좌우 225px (배경 영역만 배치) / 텍스트+로고+버튼 상단 50px·하단 35px·좌우 240px 여백 준수 / 텍스트 최대 52px·최소 22px·최대 4줄(광고주 로고 제외) / 투명 배경 사용 불가 / 좌우 양끝 그라데이션 표현 불가', isUserInput: false },
          { displayOrder: 2, areaName: '광고 카피 및 CTA 버튼', areaType: AssetAreaType.TEXT, specLabel: '안전 영역(상단 50px·하단 35px·좌우 240px) 내 배치 / 텍스트 최대 4줄 / 나눔고딕 또는 고딕계열 권장', isUserInput: true },
          { displayOrder: 3, areaName: '랜딩 URL', areaType: AssetAreaType.URL, specLabel: null, isUserInput: true },
        ],
      },
    ],
